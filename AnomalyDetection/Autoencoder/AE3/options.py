...
class Options():
    def __init__(self):
        ...
        self.parser.add_argument('--name', type=str, default='screw')
        ...
        self.parser.add_argument('--do_aug', default=True, help='whether to do data augmentation before training')
        ...
        self.parser.add_argument('--augment_num', type=int, default=1000)
        ...
        self.parser.add_argument('--p_horizontal_flip', type=float, default=0.3, help='probability to do horizonal flip')
        self.parser.add_argument('--p_vertical_flip', type=float, default=0.3, help='probability to do vertical flip')

        self.parser.add_argument('--z_dim', type=int, default=10, help='dimension of the latent space vector')
        self.parser.add_argument('--flc', type=int, default=32, help='number of the first hidden layer channels')

        self.parser.add_argument('--epochs', type=int, default=150, help='maximum training epochs')
    ...
    def parse(self):
        ...
        if not self.opt.train_data_dir:
            self.opt.train_data_dir = DATASET_PATH + '/train/good'
